...
namespace SajetClass
{
    class SajetCommon
    {
        ...
        public static DialogResult ShowMessage(string message, MessageBoxIcon icon = MessageBoxIcon.Error)
        {
            return MessageBox.Show(SetLanguage(message), icon.ToString(), MessageBoxButtons.OK, icon);
        }
