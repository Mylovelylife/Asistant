...
namespace RepairDll
{
    public partial class fMain : Form
    {
        ...
        private void editSN_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            // 如果已經有第一筆SN在處理中，後續輸入的SN自動執行 Add + Repair
